...
exports.createSubCategoriaSchema = zod_1.z.object({
    ...
    categoriaId: zod_1.z.number().int().positive("categoriaId debe ser un número positivo"),
...
exports.updateSubCategoriaSchema = zod_1.z.object({
    nombre: zod_1.z
        ...
        .optional(),
    descripcion: zod_1.z.string().max(500, "Descripción no puede exceder 500 caracteres").optional(),
    categoriaId: zod_1.z.number().int().positive("categoriaId debe ser un número positivo").optional(),
